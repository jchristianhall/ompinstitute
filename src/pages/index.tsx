  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <TextBlock className="px-12">
        ...
        opened in February of that year. School founder David A. Hall is a firm
        believer in providence. That, along with encouragement from his devoted
        wife, is what ultimately encouraged him to move from teaching private
        lessons part time around the tri-county area to founding the school. By
        combining his efforts with those of other well-rounded martial artists,
        he hopes to create a Kwan that will take on a life of its own.
      </TextBlock>
      ...
      <TextBlock className="px-12">
        Mr. Hall takes students for all disciplines on a smaller scale and still
        teaches around the tri-county area. He is also available for seminars
        and Health and Wellness Programs in the area.
      </TextBlock>
